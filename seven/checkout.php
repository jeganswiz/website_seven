                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-left">
                                <button class="btn btn-default" style="margin-top: 0px;">Account</button>
                                <button class="btn btn-default" style="margin-top: 0px;">Orders</button>
                                


                            </div><!-- end col -->
                            <div class="col-sm-6 text-left">
                                <h2 style="margin-top: 0px;" class="title">Checkout</h2>
                            </div><!-- end col -->
                        </div><!-- end row -->
                            ...
                            <div class="col-sm-12">
                                <ul class="nav nav-pills style2 nav-justified">
                                    <li id="sc" class="active">
                                        <a href="#shopping-cart" data-toggle="tab" onclick="openNext();">
                                            1. Shopping Cart
                                            <div class="icon">
                                    ...
                                    <li id="bi">
                                        <a href="#billing-info" data-toggle="tab" onclick="closeNext();">
                                            2. Billing Info
                                            <div class="icon">
                                    ...
                                    <li id="pay">
                                        <a href="#payment" data-toggle="tab" onclick="closeNext();">
                                            3. Payment
                                            <div class="icon">
                                    ...
                                    <div class="tab-pane" id="billing-info">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <a class="nextButton btn-lg next-align" onclick="hideButton1()" href="#payment" style="padding-left: 40px;padding-right: 40px;" data-toggle="tab"> Next</a>
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingPayment2">
                                                            <h4 class="panel-title">
                                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordionPayment" href="#collapsePayment2" aria-expanded="false" aria-controls="collapsePayment2">
                                                                    <i class="fa fa-money mr-10"></i>Pay with COD
                                                                </a>
                                                            </h4>
                                                        </div><!-- end panel-heading -->
                                                        <div id="collapsePayment2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingPayment2">
                                                            <div class="panel-body">
                                                                <div class="form-group">
                                                                    <div class="checkbox-input checkbox-primary mb-10">
                                                                        <input id="pay-with-cod" class="styled" type="checkbox">
                                                                        <label for="pay-with-cod">
                                                                            <i class="fa fa-money mr-5"></i>Checkout with Cash-on-delivery
                                                                        </label>
                                                                    </div><!-- end checkbox-input -->
                                                                </div><!-- end form-group -->
                                                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="table-responsive"> 
                                            <table class="table no-border">
                                                ...
                                                <tr>
                                                      <th>  </th>
                                                    <td style="padding: 0px;"><a class="nextButton nB btn-lg" style="padding-left: 40px;padding-right: 40px;"  onclick="hideButton()" href="#billing-info" data-toggle="tab"> Next </a></td>
